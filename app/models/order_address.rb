class OrderAddress
  ...
  attr_accessor :building, :house_number, :municipality, :prefecture_id, :postal_code, :phone_number, :user_id, :item_id, :token
  ...
  with_options presence: true do
    ...
    validates :phone_number, format: { with: /\A[0-9]{10,11}\z/, message: "must be without hypen(-) and 10/11 characters"}
